...
ok $pCOMMAND.parse('развърни в дълга форма със id колоните ID1, ID2 със променливи колони V1 и V2'),
        'развърни в дълга форма със ИД колоните ID1, ID2 със променливи колони V1 и V2';

ok $pCOMMAND.parse('превърни в дълга форма използвайки идентификаторни колони ID1, ID2 и със променливи колони V1 и V2'),
        'превърни в дълга форма използвайки идентификаторни колони ID1, ID2 и със променливи колони V1 и V2';
