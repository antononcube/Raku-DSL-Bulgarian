...
направи документ-термин матрица и с атоматични стоп думи;
извади 12 теми използваки NNMF и максимакен брой стъпки 12;
покажи текущата лентова стойност");

@testCommands = ("
създай със textHamlet;
направи документ-термин матрица със automatic stop words;
