...
role DSL::Bulgarian::DataQueryWorkflows::Grammar::DataQueryPhrases {
    ...
    token duplicate-adjective:sym<Bulgarian> { :i 'дублиран' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'дублиран', 2) }> | 'повторен' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'повторен', 2) }> }
    token duplicates-noun:sym<Bulgarian> { :i 'дублирани' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'дублирани', 2) }> | 'повторени' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'повторени', 2) }> }
    ...
    token full-adjective:sym<Bulgarian> { :i 'пълен' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'пълен', 2) }> | 'пълна' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'пълна', 2) }> | 'пълно' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'пълно', 2) }> }
    ...
    token inner-adjective:sym<Bulgarian> { :i 'вътрешен' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'вътрешен', 2) }> | 'вътрешна' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'вътрешна', 2) }> | 'вътрешно' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'вътрешно', 2) }> }
    ...
    token left-adjective:sym<Bulgarian> { :i 'ляв' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'ляв', 1) }> | 'ляво' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'ляво', 2) }> | 'лява' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'лява', 2) }> }
    token long-adjective:sym<Bulgarian> { :i 'дълъг' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'дълъг', 2) }> | 'дълга' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'дълга', 2) }> | 'дълго' | ([\w]+) <?{ is-bg-fuzzy-match($0.Str, 'дълго', 2) }> }
    token longer-adjective:sym<Bulgarian> { :i  'по-дълъг' | 'по-дълга' | 'по-дълго'  }
